...
def get_func_and_save_dir(model_type, save_root):
    ...
    save_dir = os.path.join(save_root, f"{model_type}_variation_3")
...
def test_var_1(
    ...
    var_json_path = "/home/hong/hongyu/violin/benchmark/metadata/Variation_3_metadata.csv",
):
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="Run Variation-3 variations.")
    parser.add_argument(
        '--model', 
        type=str, 
    )
