...
def test_var_1(
    ...
    var_json_path = "/home/hong/hongyu/violin/benchmark/metadata/Variation_1_metadata.csv",
):
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="Run Variation-1 variations.")
    parser.add_argument(
        '--model', 
        type=str, 
    )
